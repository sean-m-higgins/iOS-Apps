...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: "https://www.googleapis.com/blogger/v3/blogs/2399953/posts?key=AIzaSyDwESmBNxbP6dz3Tx4DBrPtAxSCOj5dO2U")!
            ...
            if error != nil {
                ...
                if let url_content = data {
                    ...
                    do {
                        ...
                        if let items = json_result["items"] as? NSArray {
